"""
Django settings for plain_truth_42254 project.
...
ROOT_URLCONF = 'plain_truth_42254.urls'
...
WSGI_APPLICATION = 'plain_truth_42254.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_truth_42254 API",
    "DESCRIPTION": "API documentation for plain_truth_42254 App",
    "VERSION": "v1",
}
